...
if __name__ == "__main__":
    parseFooDBCSVFile('C:/Phil/Work/Informatics/Robokop/FooDB/FooDB_rawdata/contents - Copy.csv' ) # contents foods 'C:/Phil/Work/Informatics/Robokop/FooDB/FooDB_rawdata/.csv' sys.argv[2]
